def generate_html():
    ...
    * {margin:0; padding:0; box-sizing:border-box;}
    ...
    html = f"""<!DOCTYPE html>
<html lang="es"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Multiplicación 2 - Interactivo</title><style>{css}</style>
<style>
@media print {
